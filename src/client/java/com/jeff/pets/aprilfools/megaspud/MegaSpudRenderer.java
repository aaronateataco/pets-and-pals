package com.jeff.pets.aprilfools.megaspud;

import com.jeff.pets.aprilfools.MegaSpud;
...
public class MegaSpudRenderer extends MobRenderer<@NotNull MegaSpud, @NotNull SlimeRenderState, @NotNull MegaSpudModel> {

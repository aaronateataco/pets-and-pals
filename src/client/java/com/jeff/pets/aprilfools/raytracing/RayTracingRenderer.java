package com.jeff.pets.aprilfools.raytracing;

import com.jeff.pets.aprilfools.RayTracing;
...
public class RayTracingRenderer extends MobRenderer<@NotNull RayTracing, @NotNull AvatarRenderState, @NotNull HumanoidModel<@NotNull AvatarRenderState>> {

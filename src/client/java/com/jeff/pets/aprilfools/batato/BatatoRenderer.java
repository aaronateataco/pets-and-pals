package com.jeff.pets.aprilfools.batato;

import com.jeff.pets.aprilfools.Batato;
...
public class BatatoRenderer extends MobRenderer<@NotNull Batato, @NotNull BatRenderState, @NotNull BatatoModel> {

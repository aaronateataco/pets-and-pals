package com.jeff.pets.aprilfools.pinkwither;

import com.jeff.pets.aprilfools.PinkWither;
...
public class PinkWitherRenderer extends MobRenderer<@NotNull PinkWither, @NotNull WitherRenderState, @NotNull WitherBossModel> {

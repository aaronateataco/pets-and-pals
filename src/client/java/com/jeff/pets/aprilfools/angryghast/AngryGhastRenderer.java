package com.jeff.pets.aprilfools.angryghast;

import com.jeff.pets.aprilfools.AngryGhast;
...
public class AngryGhastRenderer extends MobRenderer<@NotNull AngryGhast, @NotNull GhastRenderState, @NotNull GhastModel> {
    ...
    @Override
    public void extractRenderState(AngryGhast ghast, GhastRenderState state, float f) {

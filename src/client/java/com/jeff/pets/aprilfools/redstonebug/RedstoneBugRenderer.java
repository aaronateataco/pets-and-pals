package com.jeff.pets.aprilfools.redstonebug;

import com.jeff.pets.aprilfools.RedstoneBug;
...
public class RedstoneBugRenderer extends MobRenderer<@NotNull RedstoneBug, @NotNull LivingEntityRenderState, @NotNull SilverfishModel> {

...
public class NerdCreeperNerdLayer extends RenderLayer<@NotNull CreeperRenderState, @NotNull CreeperModel> {
    ...
    public static final ModelLayerLocation NERD_CREEPER_LOCATION = new ModelLayerLocation(Identifier.withDefaultNamespace("textures/entity/nerd_creeper_overlay.png"), "main");

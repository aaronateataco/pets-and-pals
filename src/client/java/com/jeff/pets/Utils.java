...
public class Utils {
     ...
     * in the config. Additionally, this method provides a layer of safety that ensures that Minecraft will not
     ...
     * @return {@code True} if the current activepet matches {@code activePet}, the {@code entity} is not
     *  {@code null}, and the entities' name does not match the set name in the config.
     * {@code False} if any of the conditions are not met.*/
    public static boolean checkName(String activePet, AbstractPet entity, String petName) {

...
public class HornedSheepRenderer extends AbstractEarthSheepRenderer<HornedSheep, HornedSheepModel> {
    ...
    public HornedSheepRenderer(EntityRendererProvider.Context context) {
        super(context, new HornedSheepModel(context.bakeLayer(HORNED_SHEEP_LOCATION)), 0.75f);
        this.addLayer(new CustomSheepWoolLayer<>(this, HORNED_SHEEP_WOOL_LOCATION, context.getModelSet()));
    }

    @Override
    public @NotNull Identifier getTextureLocation(@NotNull SheepRenderState state) {
        return Identifier.fromNamespaceAndPath(MOD_ID, "textures/entity/minecraft_earth/sheep/horned_sheep.png");
    }

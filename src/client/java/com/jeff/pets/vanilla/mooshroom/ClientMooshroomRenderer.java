...
public class ClientMooshroomRenderer extends MobRenderer<@NotNull ClientMooshroom, @NotNull MushroomCowRenderState, @NotNull CowModel> {
    ...
    @Override
    public void extractRenderState(ClientMooshroom mooshroom, MushroomCowRenderState state, float f) {

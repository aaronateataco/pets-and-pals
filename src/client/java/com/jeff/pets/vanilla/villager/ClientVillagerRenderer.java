...
public class ClientVillagerRenderer extends MobRenderer<@NotNull ClientVillager, @NotNull VillagerRenderState, VillagerModel> {
    ...
    @Override
    public void extractRenderState(ClientVillager villager, VillagerRenderState state, float f) {
        super.extractRenderState(villager, state, f);
        state.isUpsideDown = villager.getPlainTextName().equals("Grumm") || villager.getPlainTextName().equals("Dinnerbone");
    }
}

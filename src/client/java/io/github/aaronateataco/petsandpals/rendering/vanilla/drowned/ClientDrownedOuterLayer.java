package io.github.aaronateataco.petsandpals.rendering.vanilla.drowned;
...
public class ClientDrownedOuterLayer extends RenderLayer<@NotNull ZombieRenderState, @NotNull ClientDrownedModel> {
    ...
    public void submit(@NotNull PoseStack poseStack, @NotNull SubmitNodeCollector submitNodeCollector, int i, ZombieRenderState entityRenderState, float f, float g) {
        ...
        submitNodeCollector.order(1).submitModel(this.drownedModel, entityRenderState, poseStack, RenderTypes.entityTranslucent(Identifier.withDefaultNamespace("textures/entity/zombie/drowned_outer_layer.png")), i, overlayCoords, -1);
    }

package io.github.aaronateataco.petsandpals.rendering.vanilla.rabbit;

import io.github.aaronateataco.petsandpals.mob.vanilla.passive.ClientRabbit;
...
public class ClientRabbitRenderer extends PetRenderer<@NotNull ClientRabbit, @NotNull RabbitRenderState, @NotNull ClientRabbitModel> {
    ...
    public @NotNull Identifier getTextureLocation(RabbitRenderState rabbitRenderState) {
        switch (CONFIG.rabbitSkin) {
            case "brown" -> rabbitTextureLocation = "textures/entity/rabbit/rabbit_brown.png";

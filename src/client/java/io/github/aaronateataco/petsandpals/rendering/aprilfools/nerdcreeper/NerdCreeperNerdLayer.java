package io.github.aaronateataco.petsandpals.rendering.aprilfools.nerdcreeper;
...
public class NerdCreeperNerdLayer extends RenderLayer<@NotNull CreeperRenderState, @NotNull CreeperModel> {
    ...
    public void submit(@NotNull PoseStack poseStack, @NotNull SubmitNodeCollector submitNodeCollector, int i, CreeperRenderState entityRenderState, float f, float g) {
        ...
        submitNodeCollector.order(1).submitModel(this.nerdCreeperLayer, entityRenderState, poseStack, RenderTypes.entityTranslucent(Identifier.withDefaultNamespace("textures/entity/creeper/nerd_creeper_overlay.png")), i, overlayCoords, -1);
        poseStack.popPose();
    }
}

package io.github.aaronateataco.petsandpals.rendering.aprilfools.megaspud;
...
public class MegaSpudOuterLayer extends RenderLayer<@NotNull SlimeRenderState, @NotNull MegaSpudModel> {
    ...
    public void submit(@NotNull PoseStack poseStack, @NotNull SubmitNodeCollector submitNodeCollector, int i, SlimeRenderState entityRenderState, float f, float g) {
        ...
        submitNodeCollector.order(1).submitModel(this.model, entityRenderState, poseStack, RenderTypes.entityTranslucent(Identifier.withDefaultNamespace("textures/entity/slime/mega_spud.png")), i, overlayCoords, -1);
    }
}

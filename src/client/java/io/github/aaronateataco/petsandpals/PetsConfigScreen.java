        ...
        return parentScreen -> {
            ...
            return YetAnotherConfigLib.createBuilder()
                    ...
                    .save(() -> {
                        ...
                        Minecraft.getInstance().gui.setScreen(this.getAdvancedConfigScreenFactory().create(null));
                    ...
                    .category(ConfigCategory.createBuilder()
                            ...
                            .option(ButtonOption.createBuilder()
                                    ...
                                    .action((_, _) -> Util.getPlatform().openUri("https://github.com/aaronateataco/pets-and-pals"))
                                    .text(Component.literal("github.com/aaronateataco/pets-and-pals"))
                                    .build())
                            .build())
                    .build()

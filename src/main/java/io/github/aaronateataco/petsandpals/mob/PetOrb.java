...
public class PetOrb extends Entity {
    ...
    public void tick() {
        ...
        // Glide to a point floating at the owner's right hip - through walls if needed,
        // that's the whole point of the ghost form.
        ...
        Vec3 anchor = owner.position().add(right.scale(0.9)).add(0.0, 1.1 + bob, 0.0);
